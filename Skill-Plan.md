...
| `uni:architecture-decision-records` | Entscheidung als ADR = **Rohstoff**; Logbuch-Konsolidierung via `update-docs`/manuell (Pflichtdokument, benotet) | CR/WG | WP2/WP8 |
| `uni:update-docs` | **API-Doku** (Pflichtdokument) synchron halten + Entscheidungslogbuch konsolidieren | WG | WP8 |
...
| 2 | Projekthintergrund (Bewertung) | **Entscheidungslogbuch** ist Pflichtdokument + benotet, hatte keinen Skill | `uni:architecture-decision-records` zu Backend-Devs (WP2/WP8) ergänzt |
| 3 | Projekthintergrund (Bewertung) | **API-Doku** ist Pflichtdokument, nicht abgedeckt | `uni:update-docs` zu Backend-Devs (WP8) ergänzt |
